...
impl LayoutConstants {
    ...
    pub fn small() -> Self {
        LayoutConstants {
            constraint_degree: 2,
            cpu_component_step: 1, // TODO: Verify this as it wasn't present in the autogenerated consts
            num_columns_first: 23,
            num_columns_second: 2,
        }
    }
    // TODO: Verify this as it was inside the `all_cairo` folder and not `plain` folder.
    pub fn plain() -> Self {
        LayoutConstants {
            constraint_degree: 2,
            cpu_component_step: 1, // TODO: Verify this as it wasn't present in the autogenerated consts
